...
//
//
// NOTE: FILE HAS BEEN COMMENTED OUT AS TEST HAVE BEEN UPDATED IN CafeXFinalPracticalMethodsTest.scala -> The below tests were based on the final exercise being completed using functions
//
//// Menu
